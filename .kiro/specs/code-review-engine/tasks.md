...
- [x] 9. Adicionar Testes para Componentes sem Cobertura
  ...
  - [x] 9.3 Criar toast.test.tsx
    ...
    - _Requirements: 7.1_
  - [ ] 9.4 Criar table.test.tsx
    - Testar estrutura de tabela
    - Testar subcomponentes
    - _Requirements: 7.1_
  - [ ] 9.5 Escrever property tests para ARIA Compliance
    - **Property 5: ARIA Compliance**
    - **Validates: Requirements 6.1, 6.2**
  - [ ] 9.6 Escrever property test para Toast Role Based on Status
...
- [ ] 11. Criar CHANGELOG.md
  - [ ] 11.1 Criar arquivo CHANGELOG.md na raiz
    - Seguir formato Keep a Changelog
    - Documentar versão atual (0.0.0)
    - Listar features implementadas
    - _Requirements: 10.4_

- [ ] 12. Adicionar Property Tests para Componentes Existentes
  - [ ] 12.1 Escrever property test para Component Contract Compliance
    - **Property 1: Component Contract Compliance**
    - **Validates: Requirements 2.1, 2.2**
  - [ ] 12.2 Escrever property test para Token Format Validity
    - **Property 8: Token Format Validity**
    - **Validates: Requirements 12.1**

## Fase 3: Melhorias de Arquitetura (P2)

- [ ] 13. Criar Pacote de Hooks
  - [ ] 13.1 Criar estrutura do pacote packages/hooks
    - Criar package.json
    - Criar tsconfig.json
    - Criar tsup.config.ts
    - _Requirements: 1.3_
  - [ ] 13.2 Extrair hooks reutilizáveis
...
- [ ] 14. Criar Gerador de Scaffolding
  - [ ] 14.1 Configurar plop ou hygen
...
- [ ] 15. Implementar Imports Diretos por Componente
  - [ ] 15.1 Atualizar package.json exports
    - Adicionar exports para cada componente
    - Exemplo: "@pineapple-ui/core/button"
    - _Requirements: 8.2_
  - [ ] 15.2 Atualizar tsup.config.ts
    - Configurar entry points múltiplos
    - _Requirements: 8.2_

- [ ] 16. Final Checkpoint - Garantir que todos os testes passam
  - Ensure all tests pass, ask the user if questions arise.
